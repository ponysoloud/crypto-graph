...
final class Transaction: NSManagedObject {
    ...
    @NSManaged private(set) var market: String
    ...
    static func insert(into context: NSManagedObjectContext, coin: Coin, type: TransactionType, quantity: Float, date: Date, price: Float, market: String, currencyType: Price.CurrencyType) -> Transaction {
